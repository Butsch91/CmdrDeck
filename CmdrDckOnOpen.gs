...
function OnOpen() {
  ...
  var FuncMenuButtons = [{name: "Generate New Deck Version", functionName: "fcnGenerateNewVersion"}, {name: "Get Staple Cross Reference",functionName: "GetStapleCrossRef"}, {name: "Generate Gatherer Links", functionName: "fcnGathererLink"}, {name: "Clear Gatherer Links", functionName: "fcnClearGathererLink"}, {name: "Hide Columns", functionName: "fcnHideColumns"}, {name: "Show Columns", functionName: "fcnShowColumns"}];
